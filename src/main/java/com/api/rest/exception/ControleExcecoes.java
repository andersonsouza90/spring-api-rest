...
public class ControleExcecoes extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		objErro.setErro(msg);
		objErro.setCodigo(status.value() + " => " + status.getReasonPhrase());
	...
	protected ResponseEntity<Object> handleExceptionDataIntegry(Exception ex){
		...
		ObjetoErro objErro = new ObjetoErro();
		objErro.setErro(msg);
		objErro.setCodigo(HttpStatus.INTERNAL_SERVER_ERROR + " => " + HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase());
		
		return new ResponseEntity<Object>(objErro, HttpStatus.INTERNAL_SERVER_ERROR);
	}
